...
- `packages/contract` — **`@mikan/contract`**: the backend⇄UI contract (IPC + view-model
...
- `packages/contract/src/api/index.ts` — the stable public surface callers import (`@mikan/contract/api`).
