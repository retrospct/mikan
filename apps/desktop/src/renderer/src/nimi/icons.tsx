...
const NM_PATHS: Record<string, ReactNode> = {
  ...
  settings: (
    <>
      ...
      <path d="M19.4 12c0-.5-.05-1-.13-1.47l1.86-1.45-1.8-3.12-2.2.9a7.3 7.3 0 0 0-2.53-1.46L14 3h-4l-.6 2.4a7.3 7.3 0 0 0-2.53 1.46l-2.2-.9-1.8 3.12 1.86 1.45a7.4 7.4 0 0 0 0 2.94L1.07 15.4l1.8 3.12 2.2-.9a7.3 7.3 0 0 0 2.53 1.46L10 21h4l.6-2.4a7.3 7.3 0 0 0 2.53-1.46l2.2.9 1.8-3.12-1.86-1.45c.08-.47.13-.97.13-1.47z" />
    </>
  )
}
