...
// @mikan/contract has 5 subpath exports (./views, ./api, ./ipc, etc.).
...
// Enable package.json `exports` field resolution so @mikan/contract/* subpaths
// (e.g. @mikan/contract/views, @mikan/contract/api) resolve correctly under Metro.
