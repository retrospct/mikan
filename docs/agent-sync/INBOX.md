...
@all ✅ **Monorepo migration (#0) MERGED** — branch off `main` (paths: `apps/desktop/src/…`, contract = `@mikan/contract` at `packages/contract`). Hold lifted.
