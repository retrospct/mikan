    ...
    return (
      <Tailwind>
        ...
        <Text className="text-[12px] leading-6 text-neutral-500">
          ...
          <Link className="text-neutral-700 underline" href="https://app.dub.co/account/settings">
            Unsubscribe here.
          </Link>
        </Text>
  ...
  return (
    <Tailwind>
      ...
      <Text className="text-[12px] leading-6 text-neutral-500">
        ...
        you can ignore this email. If you are concerned about your account's safety, please reply to this email to get
        in touch with us.
      </Text>
